...
export class ViewAllComponent implements OnInit {
  ...
  fashionListings:any[]=[{
    name:"John Players",
    location:"Texas,Tokyo,Russia",
    thumbnailUrl:"../../../../assets/img/menfashion1.jpg"
  }]
...
console.log(appState)
  ...
  getfashionListing(){
    this._httpService.getfashionListing({creatorId:this.loggedInUserId})
    .subscribe(
      data => {
        console.log("getbusinessListing")
          console.log(data)
      this.fashionListings =  data["businessListings"]
      },
      error => {
